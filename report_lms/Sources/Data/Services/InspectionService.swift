...
final class InspectionService: InspectionServiceType {
    ...
    func getInspections() async throws -> [InspectionModel] {
        ...
        print("🔧 [InspectionService] getInspections() called, returning " +
              "\(inspections.count) inspections from global store")
        return inspections
    }
    ...
    func getInspection(id: String) async throws -> InspectionModel {
        ...
        throw NSError(domain: "InspectionService", code: 404,
                      userInfo: [NSLocalizedDescriptionKey: "Inspection not found"])
    }
}
